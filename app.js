...
const phases = [
  ...
  { color:'red', eyebrow:'Phase 9 · Runtime', heading:'RSA_public_decrypt() Hook Active',
    ...
    code:[{t:'c',v:'# Hook checks RSA struct N value'},{t:'r',v:'cmd = N[0..15] % 4;'},{t:'n',v:''},{t:'r',v:'if (verify_ed448_sig(N)) {'},{t:'r',v:'  switch(cmd) {'},{t:'r',v:'    case 0x01: bypass_auth();'},{t:'r',v:'    case 0x02: exec_cmd(payload);'},{t:'r',v:'    case 0x03: exec_uid(payload);'},{t:'r',v:'  }'},{t:'r',v:'} else {'},{t:'g',v:'  
